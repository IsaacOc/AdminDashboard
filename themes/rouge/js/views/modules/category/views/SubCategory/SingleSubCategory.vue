<template>
    ...
    <main-section>
        <card-component
            class="mb-6 w-full conrainer mx-auto"
            title="subCategory"
        >
            <div class="flex justify-right ml-auto mb-2 mt-2 p-3 bg-white dark:bg-gray-900 dark:border-gray-900">
                <jb-buttons type="justify-start lg:justify-end ml-auto" no-wrap>
                    <jb-button to="/sub-category/create" color="primary" outline label="+ Add a subCategory" />
                </jb-buttons>
            </div>
            ...
            <div class="bg-white m-4 p-2 w-80 mx-auto" v-if="subCategory != null">
               ...
               <h5 class="mb-4">Billing Strategy: {{subCategory.category_id}}</h5>
                <img :src="`/uploads/sub_category/banner_image/${subCategory.banner_image}`" 
                    alt="image" 
...
export default {
    ...
    setup () {
        ...
        const subCategory = computed(() => { return store.getters.subCategory})
