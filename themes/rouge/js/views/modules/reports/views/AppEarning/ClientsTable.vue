        ...
        <table>
            ...
            <tbody>
                <tr v-for="client in itemsPaginated" :key="client.id">
                    ...
                    <td data-label="Create Booking Date: Minute">
                        {{ client.name }}
                    </td>
                    <td data-label="Customer Name">{{ client.name }}</td>
                    <td data-label="Category Name">{{ client.company }}</td>
                    <td data-label="City Name">{{ client.city }}</td>
                    <td data-label="Category Name" class="progress-cell">
                    ...
                    <td data-label="App Earning">{{ client.city }}</td>
